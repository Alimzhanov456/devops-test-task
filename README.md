...
В репозитории находится выполненное тестовое задание.
...
Ответ на дополнительный вопрос A1:  
Файл `index.html` можно передавать в контейнер без пересборки образа с помощью volume (bind mount)
```bash
...
- выводит найденные файлы и запрашивает подтверждение 
